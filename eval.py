...
# python eval.py experiments/seg_detector/ic15_resnet18_deform_thre.yaml --resume outputs/workspace/DB-master/SegDetectorModel-seg_detector/deformable_resnet18/L1BalanceCELoss/model/final --box_thresh 0.55
# python eval.py experiments/seg_detector/ic15_resnet18_deform_thre.yaml --resume outputs/ic15_resnet18  --box_thresh 0.55
